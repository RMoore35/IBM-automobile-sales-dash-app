...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard",style={'textAlign': 'center', 'color': '#503D36',
                                'font-size': '24px'}),#May include style for title
...
def update_output_container(selected_statistics, input_year):
    if selected_statistics == 'Recession Period Statistics':
        ...
        #recession_data = recession_data[recession_data['Year']==input_year]
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(
            figure=px.bar(average_sales,
               x='Vehicle_Type',
               y='Automobile_Sales',
               title="Vehicle-Wise Sales during Recessions"))
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        R_chart4 = dcc.Graph(
                       figure=px.bar(unemp_rec,
                           x='Vehicle_Type',
                           y='unemployment_rate',
                           title="Effect of Unemployment Rate on Vehicle-Wise Sales"))
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas, 
                x='Year',
                y='Automobile_Sales',
                title="Average Automobile Sales fluctuation over Yearly Periods"))
